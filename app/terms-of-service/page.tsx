...
export const metadata: Metadata = {
  title: `Terms of Service — PawsTales`,
  description: `Terms of service for paws-tales.com.`,
};
  ...
  return (
    <div className="static-page">
      <div className="static-page-inner">
        ...
        <section><h2>1. Acceptance</h2><p>By using paws-tales.com you agree to these Terms.</p></section>
        ...
        <section><h2>5. Intellectual Property</h2><p>All content is owned by or licensed to PawsTales.</p></section>
